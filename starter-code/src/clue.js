...
function pickMistery() {
   ...
   //Reaviling the mistery
   function revealMistery (arregloMisterio){
    return arregloMisterio[0].first_name + " " +arregloMisterio[0].last_name + " killed Mr.Boddy using the " + arregloMisterio[1].name+ " in the " + arregloMisterio[2].name + "!!!!";
  }
